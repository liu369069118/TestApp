...
- (void)dismiss{
    ...
    [UIView animateWithDuration:kActionDuration animations:^{
        [_coverViewWeak setAlpha:0];
        _bgViewWeak.frame = CGRectMake(0, ScreenHeight, _bgViewWeak.frame.size.width, _bgViewWeak.frame.size.height);
...
- (void)relayoutSubViewPortrait{
    ...
    @WeakObj(_bgView);
    [UIView animateWithDuration:kActionDuration animations:^{
        _bgViewWeak.frame = CGRectMake(0, ScreenHeight - _bgViewWeak.frame.size.height, _bgViewWeak.frame.size.width, _bgViewWeak.frame.size.height);
    }];
}
...
- (void)reLayoutSubViewLeftOrRight{
    ...
    @WeakObj(_bgView);
    [UIView animateWithDuration:kActionDuration animations:^{
        _bgViewWeak.frame = CGRectMake(0,ScreenWidth - _bgViewWeak.frame.size.height, _bgViewWeak.frame.size.width, _bgViewWeak.frame.size.height);
    }];
}
