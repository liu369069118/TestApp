//
//  BNCDStovkDetailViewController.m
//  BNCD
//
//  Created by tomsom on 2019/6/22.
...
@interface SXHGTYStockDetailViewController ()
...
@implementation SXHGTYStockDetailViewController
...
- (void)viewDidLoad {
    ...
    SXHGTYGPListViewController *vc = [SXHGTYGPListViewController new];
    NSMutableArray *l = [WBUitl mainDataList];
