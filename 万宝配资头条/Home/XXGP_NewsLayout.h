...
@interface XXGP_NewsLayout : NSObject

@property (nonatomic, strong) XXGP_NewsModel *news;
...
- (instancetype)initWithNews:(XXGP_NewsModel *)news;
- (instancetype)initWithNews:(XXGP_NewsModel *)news isHistory:(BOOL)isHistory;

- (instancetype)initWithTopicDetailNews:(XXGP_NewsModel *)news;
- (void)layout;
