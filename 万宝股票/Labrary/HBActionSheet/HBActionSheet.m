...
#define TITLE_TEXT_COLOR                    HCColor(77, 77, 77)     //标题
#define DESCRIPTIVE_TEXT_COLOR              HCColor(128, 128, 128)  //描述文字
#define CANCELANDOTHER_BUTTON_TITLE_COLOE   HCColor(0, 118, 255)    //蓝色
#define DESCRIPTIVE_BUTTON_TITLE_COLOR      HCColor(254, 56, 36)    //红色

#define SELECTED_BUTTON_COLOR               HCColor(204, 204, 204)  //button选中颜色
#define BUTTON_HEIGHT   60
#define CONTROL_INTERVAL 14.0f
#define TEXT_MARGIN 60.0f

typedef void(^touchItemBlock)(HBActionSheet *, NSString *, NSInteger );
                              ...
                              itemAction:(void(^)(HBActionSheet *actionSheet, NSString *title, NSInteger index))itemAction;
{
    ...
    if (self) {
        ...
        _touchItemBlock = ^(HBActionSheet *action, NSString *title, NSInteger index){
...
- (CGFloat)createTitleLabelWithTitle:(NSString *)title {
    ...
    titleLbl.font = kHCSystemFont15;
    titleLbl.numberOfLines = 0;
    NSDictionary *attribute = @{NSFontAttributeName: kHCSystemFont15};
...
- (CGFloat)createDescriptiveLabelWithDescriptive:(NSString *)descriptive titleBtnBottomY:(CGFloat)titleBtnBottomY {
    ...
    descriptiveLbl.font = kHCSystemFont15;
...
- (CGFloat)createOtherButtonWithOtherButtonTitles:(NSArray *)otherButtonTitles otherBtnBottomY:(CGFloat)otherBtnBottomY {
    ...
    for (int i = 0; i < count; i ++) {
        ...
        other.titleLabel.font = kHCSystemFont17;
...
- (CGFloat)createDestructiveButtonWithDestructiveButtonTitles:(NSArray *)destructiveButtonTitles destructiveBtnBottomY:(CGFloat)destructiveBtnBottomY {
    ...
    for (int i = 0; i < count; i ++) {
        ...
        destructive.titleLabel.font = kHCSystemFont17;
...
- (void)createCancelButtonWithCancelButtonTitle:(NSString *)cancelButtonTitle {
    ...
    button.titleLabel.font = kHCBoldFont17;
