...
- (void)addLeftTwoBarButtonsWithFirstImage:(UIImage *)firstImage firstAction:(SEL)firstAction secondImage:(UIImage *)secondImage secondAction:(SEL)secondAction
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 80, 44)];
    view.backgroundColor = [UIColor clearColor];
    
    UIButton *firstButton = [UIButton buttonWithType:UIButtonTypeCustom];
    firstButton.frame = CGRectMake(35, 0, 30, 44);
    ...
    secondButton.frame = CGRectMake(5, 0, 30, 44);
...
- (void)addRightBarButtonItemWithTitle:(NSString *)itemTitle action:(SEL)action
{
    ...
    rightbBarButton.titleLabel.font = [UIFont systemFontOfSize:16];
