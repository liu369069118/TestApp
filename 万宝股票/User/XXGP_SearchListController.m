...
@interface XXGP_SearchListController ()<UITableViewDataSource, UITableViewDelegate, JKRSearchControllerhResultsUpdating, JKRSearchControllerDelegate, JKRSearchBarDelegate>
...
@implementation XXGP_SearchListController
...
- (void)viewDidLoad {
    ...
    NSArray *datas = [XXGP_Uitl mainDataList];
