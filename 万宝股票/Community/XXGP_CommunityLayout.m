...
@interface XXGP_CommunityLayout ()

@property (nonatomic, assign) BOOL isFromTopicDetail;

@end

@implementation XXGP_CommunityLayout

- (instancetype)initWithTopicModel:(XXGP_CommunityModel *)topicModel {
    return [self initWithTopicModel:topicModel isFromTopicDetail:NO];
}

- (instancetype)initWithTopicModel:(XXGP_CommunityModel *)topicModel isFromTopicDetail:(BOOL)isFromTopicDetail {
    if (self = [super init]) {
