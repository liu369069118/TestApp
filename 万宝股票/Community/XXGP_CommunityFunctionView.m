...
@interface XXGP_CommunityFunctionView ()

@property (nonatomic, weak) UILabel *timeLabel;
@property (nonatomic, weak) UILabel *nameLabel;

@property (nonatomic, weak) XXGP_CommunityButton *likeButton;
@property (nonatomic, weak) XXGP_CommunityButton *commentButton;

@end

@implementation XXGP_CommunityFunctionView

- (void)setTopicModel:(XXGP_CommunityModel *)topicModel {
